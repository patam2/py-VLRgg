...
import ssl
import warnings
import simple_http.formatting as formatting
...
class Session:
    ...
    def request(
        self, method: str, page: str, headers={}, data=None, **kwargs
    ) -> Response:
        """
        ...
        try:
            ...
            self._connect()
            return self.request(method, page, headers, data, **kwargs)
        headers = formatting.parse_request_data(data)
        status_code = formatting.get_status_code(data)
        # 301 checking
